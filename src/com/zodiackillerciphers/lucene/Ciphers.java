...
public class Ciphers {
	/** a collection of test ciphers and their solutions */
	
	// MOVING THIS TO org.oranchak.Ciphers. 
	public static StringBuffer[][] ciphersOBSOLETE = new StringBuffer[][] {
		{ /* the zodiac killer's unsolved 340-character cipher */
		...
		{ /* ALisowky's 340-character cipher */
			...
			new StringBuffer("") 
		},
		{ /* bryianzum's cipher, part 1 */
			new StringBuffer("∏ÇîV∞»º^VI^Xë+ +‘ëº^»∏Çî‘Ö∞ÄJX^ôAímë+XJëº—+ô^∆ë£º^/ëÇIXy‘Ö+nJë£ôëº£íM∞—ÀÖîm+∆—º^+∞ô7£∆í∏IXyë‘∞ô∆îHX^ë£+A∞+∆mXJ%‘ºÖºÖIXyº»^Ç‘∞H‘XVn+—môÖ7X»^º§ô^ëôÖ^À∞ë§m7£+ÖíV∏ÖmIXyÇM∞‘ÄXX/Mº^∞ÖôÖë£+∏∞^ëí^»n+∏Çî‘ëX∞mô^∆íÖ/£XAë£ºÖ%ÇyÄ∆£ôHH∞^A£+^ë£+ImAínnXA∏ÇîA£XÄ+∆Ç^ën+ë∏Çî‘Ö+nJV∞VÄÀ^∆ëXô7íëômë‘XH£+IXy%ô^ëÖíM∞∏Çî‘Ö+nJJ‘Ç—ô^y^m∞+^∞^+—∏"),
			new StringBuffer("") 
		},
		{ /* kiuku's 330-char cipher */
		...
		{ /* glurk's 340-char cipher, from http://zodiackiller.21.forumer.com/a/cipher-explorer_post1719.html, converted to ascii by me */
			new StringBuffer(">J&9*+%F8$WT13+!#4*J{;.RTX*5XC;E1&<9=5^<9*;=UC]HM[,6[M3=DE}.6K#3]CQDL]X-HK-_Q*8B524T-Z&<4(7)&MKADKV<K-@KMG4@#IW0:N+=L32PJ1.Z;@6G#8I;&=5^67*-4.;KT$9!ML46C;M3V!P+H-Z#7@93SK#PBP,W:*Q*1Y,}O%]L;,;X:@A#&<GZI6ABW4V3OVU17!DZJT7IQKCJH<%$G,P\\WVF<{*{=8^G#A*=AH{S3|5+'%O!MN':OQAV$UECFZOR5FCO(5J8&\"{Q4BGSNP_Z_RTW..NVACR<@UM{C+M*N4\\PMEWZ#8_!,<[]4,(WI;XS9"),
			new StringBuffer("") 
		},
		{ /* glurk's 2nd 340-char cipher, from http://zodiackiller.21.forumer.com/a/cipher-explorer_post1719.html, converted to ascii by glurk */
		...
		{ /* ccactus's 340-char cipher, no E's, with encoding errors  */
			...
			new StringBuffer("") 
		},
		{ /* gardi's 340-char cipher.  solution is approximate (the best guess of zkdecrypto) */
			...
			new StringBuffer("") 
		},
		{ /* mikec's 340-char cipher.  */
			new StringBuffer("I4X91iZg;`GJ=b=7[2j2fKG8OPEUH6B:dXFXLfXmaJJ0QdWATXPkKZUHkl@ZHnCK4[TJA0Qnnd[gnOSK6CM\\7[U0VL32G415Y4Y9[7KT[J=?dM9;`O5=kM8bK4_CfDT=m5G5IkY4VDFcWZB`TEFcXb67fKTJ9IQ25iVJ0?diZQ]hDLQ;A^ToMkK9[]XQgHX4THmJ]D1a4_K8J;10V_3Ua45onZG=5d^IVgW5iAhBACdWL;LD]GZQAa42GcPY[URpH:;AF[72dWBD2?D765i8KAO^K1cECdM6JeH?nI4JPD1jLbO0V^KN^kWeU0XVB:gdK0VLDgR=?fK92jN7kYAU"),
		...
		{ /* smithy's 340-char cipher */
			...
			// approximate solution due to some symbols representing more than on letter
			new StringBuffer("") 
		},
		{ /* alanbenjy320.example. hints: "Its a Song Lyric.  There is a Repeated 9 letter word (not adjacent)."   http://www.zodiackillerfacts.com/forum/viewtopic.php?f=50&t=446 */
			new StringBuffer("!#$%&()*+,-./0123456789:;<=>?@(A&BCDE@F9GHI.J;/KL?MNOPQRST!U&V!()WAXYZ[,S]1^_@`a0;*bDcd:DAef=(ghEahS(+i-D_AjWklm/`BfEnopbOQGNOqrostuL$vwxyVty7z{|jz@1}Nh~Ā3sRāĂ>ăĄxOąPEĆIJą-4Yć&4|Ĉĉv^Ċćċl6ČčĎcă|4PO6ĄďĐđxRĒbĎēĔČ8XĕĄWċĖn<ėĎ0@IĘĖY2SĀ0;đĎęďĐNI@ĚĚhďěĂ-ĜĎ%;ĕ#ĝ86JĚxX[ĞO[>W@ĉĜĂ}Ď&8ēhğPĔĞkĠw9:Zġ}ćMĢģSpĔQ9ğzPTģĢĤCďāxĄ!u9Y1ġĂSB85ĕ"),
			new StringBuffer("????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????")
		}
