...
*/
	...
	public static void testLucene060() {
		...
		float[] scores = new float[] {NGrams.zkscore(sb), 
				1/(1+Stats.iocDiff(sb)), 
				ProblemLucene.zodiacScore(sb), 
				nd1[0], nd1[1], nd2[0], nd2[1], nd3[0], nd3[1], 
				((float)1)/(1+NGrams.badNgraphs(2, sb)), 
				((float)1)/(1+NGrams.badNgraphs(3, sb)), 
				((float)1)/(1+NGrams.badNgraphs(4, sb)), 
				((float)1)/(1+NGrams.badNgraphs(5, sb)) 
		};
		...
		while (true) {
			...
			float[] scores2 = new float[] {NGrams.zkscore(sb), 
					1/(1+Stats.iocDiff(sb)), 
					ProblemLucene.zodiacScore(sb), 
					nd1[0], nd1[1], nd2[0], nd2[1], nd3[0], nd3[1], 
					((float)1)/(1+NGrams.badNgraphs(2, sb)), 
